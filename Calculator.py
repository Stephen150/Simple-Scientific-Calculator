...
class Calculator:
    def __init__(self, master):
        ...
        # square root
        self.btn_sqrt = tk.Button(bottom_frame, padx=16, pady=1, bd=4, fg='white', bg='#666666', font=('arial', 18),width=2,height=2, relief='flat', text="sqrt", activebackground="#666666",command=lambda: self.btnClick('sqrt('))
