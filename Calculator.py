...
class Calculator:
	def __init__(self, master):
		...
		text="(",relief='flat',activebackground="#666666",command=lambda: self.btnClick('('))
		...
		width=2, height=2,relief='flat',text=")",activebackground="#666666", command=lambda: self.btnClick(')'))
		...
		height=2,relief='flat',text="exp",activebackground="#666666", command=lambda: self.btnClick('exp('))
		self.btn_exp.grid(row=0, column=2)
		# constant pi
		self.btn_pi = tk.Button(bottom_frame, padx=16, pady=1, bd=4, fg='white',bg = '#666666', font=('arial', 18),
		width=2, height=2,relief='flat',activebackground="#666666", text="ฯ€", command=lambda: self.btnClick('pi'))
		...
		height=2,text="C",relief='flat',activebackground="#666666", command=lambda: self.btnClearAll())
		...
		height=2,text="del",relief='flat',activebackground="#666666", command=lambda: self.btnClear1())
		...
		width=2, height=2,relief='flat',text="+/-",activebackground="#666666", command=lambda: self.change_signs())
		...
		height=2,text="รท",relief='flat',activebackground="#666666", command=lambda: self.btnClick('/'))
		...
		height=2,relief='flat',text="sqrt",activebackground="#666666", command=lambda: self.btnClick('sqrt('))
		...
		text="Deg",relief='flat',activebackground="#666666",foreground='white',activeforeground = 'orange', command=lambda:self.convert_deg())
		...
		height=2,text="Rad",relief='flat',foreground='orange',activeforeground = 'orange',activebackground="#666666", command=lambda:self.convert_rad())
		...
		text="xโ ",relief='flat',activebackground="#666666", command=lambda:self.btnClick('**(1/'))
		...
		height=2,relief='flat', text="abs",activebackground="#666666", command=lambda: self.btnClick('abs' + '('))
		...
		text="7", relief='flat',activebackground="#4d4d4d",command=lambda: self.btnClick(7))
		...
		text="8",relief='flat',activebackground="#4d4d4d", command=lambda: self.btnClick(8))
		...
		text="9",relief='flat',activebackground="#4d4d4d", command=lambda: self.btnClick(9))
		...
		height=2,relief='flat',text="x",activebackground="#666666", command=lambda: self.btnClick('*'))
		...
		text="MC",relief='flat',activebackground="#666666",command=lambda:self.memory_clear())
		...
		text="log",relief='flat',activebackground="#666666",command=lambda:self.btnClick('log('))
		...
		text="4",relief='flat',activebackground="#4d4d4d", command=lambda: self.btnClick(4))
		...
		text="5",relief='flat',activebackground="#4d4d4d", command=lambda: self.btnClick(5))
		...
		text="6",relief='flat',activebackground="#4d4d4d", command=lambda: self.btnClick(6))
		...
		text="-",relief='flat',activebackground="#4d4d4d",command=lambda:self.btnClick('-'))
		...
		text="MR",relief='flat',activebackground="#666666", command=lambda: self.memory_recall())
		...
		text="ln",relief='flat',activebackground="#666666",command=lambda:self.btnClick('log1p('))
		...
		text="1",relief='flat',activebackground="#4d4d4d", command=lambda: self.btnClick(1))
		...
		text="2",relief='flat',activebackground="#4d4d4d", command=lambda: self.btnClick(2))
		...
		text="3",relief='flat',activebackground="#4d4d4d", command=lambda: self.btnClick(3))
		...
		text="M+",relief='flat',activebackground="#666666", command=lambda:self.memory_add())
		...
		text="n!",relief='flat',activebackground="#666666",command=lambda:self.btnClick('factorial('))
		...
		text=u"x\u00B2",relief='flat',activebackground="#666666",command=lambda:self.btnClick('**2'))
		...
		text="x^y",relief='flat',activebackground="#666666", command=lambda: self.btnClick('**'))
		...
		text="ans",relief='flat',activebackground="#666666",command=lambda:self.answer())
		...
		text="0",relief='flat',activebackground="#4d4d4d", command=lambda: self.btnClick(0))
		...
		text="=",relief='flat',activebackground="#666666",command=lambda:self.btnEqual())
